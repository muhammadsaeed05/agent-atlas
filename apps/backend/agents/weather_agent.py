...
async def weather_agent_node(state: TravelState) -> Dict[str, Any]:
    ...
    human_prompt = (
        ...
        "Please provide:\n"
        "1. Current temperature and weather condition for each destination city\n"
    ...
    result = await agent.ainvoke({
        "messages": [
            SystemMessage(
                content="You are a weather specialist travel agent. Use the weather tools to fetch accurate current weather and forecasts for the traveler's destination cities."
            ),
